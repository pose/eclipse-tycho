...
TYCHO_TEST_TARGET_PLATFORM="-Dtycho.testTargetPlatform=/Users/apose/Documents/tycho/eclipse/"
...
$TYCHO_M2_HOME/bin/mvn -f tycho-its/pom.xml clean test -Pparallel -U -e -V ${TYCHO_TEST_TARGET_PLATFORM} ${MAVEN_PARAMS} -DskipTests || exit
